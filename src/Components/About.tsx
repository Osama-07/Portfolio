const About = () => {
  return (
    <div id="about" className="pb-20 max-md:px-4 px-12">
      <h1 className="text-center text-6xl font-extrabold mb-20 bg-gradient-to-tr from-orange-500 via-white to-gray-500 bg-clip-text text-transparent">
      ...
      <div className="p-5 mx-14 max-md:mx-4 grid grid-cols-2 gap-y-10 max-lg:grid-cols-1 rounded-lg max-md:rounded-lg max-md:text-center">
        ...
        >
          ...
          <p className="text-lg text-justify whitespace-pre-line leading-relaxed">
        ...
        <div
          data-aos="fade-up"
          className="backdrop-blur bg-white/10 rounded-lg p-5 max-md:text-center lg:col-span-2 lg:w-7/12 lg:mx-auto"
        >
          ...
          <p className="text-lg mx-auto lg:m-0 lg-w-full text-justify whitespace-pre-line leading-relaxed">
